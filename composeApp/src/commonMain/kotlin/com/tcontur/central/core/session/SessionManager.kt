 ...
 * 3. Clear persisted auth credentials
 *
...
class SessionManager(
     ...
     * and clears the stored auth credentials.
     */
    suspend fun logout() {
        println("$TAG ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
        ...
        println("$TAG [1/3] Deteniendo servicio de tracking GPS...")
        socketServiceManager.stopLocationTracking()
        println("$TAG [1/3] ✅ Tracking GPS detenido")

        println("$TAG [2/3] Desconectando y deteniendo SocketService...")
        socketServiceManager.disconnect()
        println("$TAG [2/3] ✅ Socket desconectado y servicio detenido")

        println("$TAG [3/3] Limpiando credenciales almacenadas...")
        authRepository.logout()
        println("$TAG [3/3] ✅ Credenciales eliminadas")
